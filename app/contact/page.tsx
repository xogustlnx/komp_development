  ...
  return (
    <main className="min-h-screen bg-black text-white px-8 py-10 md:px-12 md:py-14">
      ...
      <div className="space-y-4 mb-12 text-sm leading-[1.8]">
        ...
        <p>
          현재 저희와 함께하는 방식은 두 가지입니다. <br />
          <strong>일반 외주</strong>: 충분한 예산이 준비되어 있다면, 명확한 조건 아래 빠르고 정밀하게 개발해드립니다.<br />
          <strong>지분/수익 공유</strong>: 프로젝트 성격에 따라, 지분 또는 수익 배분 기반 협업도 가능합니다.
        </p>
        <p>
          다만, 현재 단순 지분만으로는 협업을 진행하지 않으며,<br />
          최소한의 예산이 준비된 파트너와의 협업을 우선합니다.
        </p>
        <p>
          카카오톡으로 바로 문의하시거나,<br />
